...
var place = ["Reddit", "Earth", "the van down by the river", "Middle Earth", "the Emergency Room", "the parking ramp", "the dungeon", "a filthy jacuzzi tub", "the pawn shop", "the thrift shop", "the state fair", "the abominable snowman's cave", "the Death Star", "Tattooine", "Stacy's Mom's room", "Mercury", "Venus", "Mars", "Jupiter", "China", "Minnesnowta", "Minneapolis", "Hell", "Jamaica", "France"];
var verbings = ["wanking", "drizzling", "karate chopping", "wriggling", "round house kicking", "passive aggressively sighing", "running", "masticating", "parkouring", "jiving", "pancake eating", "robot dancing", "twerking", "farting", "splooging", "yelping", "flubbing", "tweaking", "proofreading", "sandwich eating", "splurging", "shellacing"];
var verb = ["wank", "drizzle", "karate chop", "wriggle", "round house kick", "extreme type", "run", "mastication", "parkour", "jive", "robot dance", "twerk", "fart", "splooge", "yelp", "flub", "tweak", "proofread", "splurg", "splooge", "shellacing"];
